...
let currentDeleteResourceType = null;
...
async function handleConfirmDelete() {
    if (!currentDeleteId || !currentDeletePublicId) {
        showToast('Missing media information.', 'error');
        return;
    }
    ...
    try {
        const response = await fetch('/.netlify/functions/delete-media', {
            ...
            body: JSON.stringify({
                ...
                resourceType: currentDeleteResourceType
            })
        });
